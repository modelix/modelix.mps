...
val mpsVersion = libs.versions.mps
val mpsMajorVersion = libs.versions.mps.major
val mpsMinorVersion = libs.versions.mps.minor
val mpsExtensionsVersion = libs.versions.mps.extensions
...
//                if (project.name in arrayOf("TODO",
//                                            "IDENTIFY",
//                                            "COMPONENTS")){
